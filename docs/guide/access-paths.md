...
Where the [Boundary Design Guide](service-team-design.md) and [Onboarding Guide](onboarding.md) mainly cover the lower lineage (service hierarchy), this guide focuses on the upper one (access path).
