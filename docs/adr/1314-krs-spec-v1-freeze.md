...
# ADR-1314: .krs / .krs.style を v1.0 として凍結する（ハイブリッド版管理）
...
- **関連**:
  ...
  - pre-freeze ADR: [ADR-1567](1567-rule-diagnostic-separation-and-catalog.md)（規則↔診断の分離 + 診断カタログ）, [ADR-1639](1639-user-system-scoped.md)（user は system-scoped）, [ADR-1566](1566-ownership-during-migration.md) / [ADR-1570](1570-shared-infra-fan-in-diagnostic.md) / [ADR-1583](1583-team-annotations-owner-priority.md)（診断 register）, [ADR-1568](1568-migration-intent-fields.md)（lifecycle annotation のパラメータ構文）, [ADR-1564](1564-remove-team-property.md)（`team` property 削除）
