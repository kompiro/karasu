...
# ADR-110: Permanent Link — `nodePathIndex` と URL hash の 2 フェーズ実装

- **日付**: 2026-03-30
- **ステータス**: 決定済み
- **関連**: Issue #110, Issue #92, [ADR-278](278-browser-history-navigation.md)
...
**Phase 2 (B-1)**: URL hash による永続リンク（ADR-278 で実装）。
