...
- **関連**:
  ...
  - 関連 ADR: [ADR-281](281-wildcard-import-two-pass-resolution.md)（wildcard import）, [ADR-292](292-directory-import.md)（directory import）, [ADR-412](412-named-import-toplevel-service.md)（top-level service named import）
