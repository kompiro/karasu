...
- **関連**:
  ...
  - 関連 TPL: [TPL-20260721-01](../test-perspectives/TPL-20260721-01-label-placement-measured-and-byte-stable.md)（本 PR で新設）、[TPL-20260711-02](../test-perspectives/TPL-20260711-02-routing-measures-crossings-and-penetrations.md)
...
- **計測して直す**: label↔node 貫通数・label↔label オーバーラップ数を数値で 0/削減 assert（TPL-20260711-02 の label 版 = TPL-20260721-01）。合成 fixture に加え実サンプル（`examples/en/ec-platform/01-system.krs`）を柵にした。
