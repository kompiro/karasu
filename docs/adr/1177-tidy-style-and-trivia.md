...
# ADR-1177: Tidy Style コマンド — `.krs.style` に trivia 保持と軸グループ並び替えを行う round-trip formatter
...
ADR-1142 で GUI 編集が単一プロパティの場合に in-place update する
...
- **GUI の append-only 予防策と相補関係**: ADR-1142 の
