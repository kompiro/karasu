...
230 ADRs across 15 topics. Clusters group by `topic` frontmatter field. Edges crossing cluster borders are cross-topic dependencies.
```mermaid
flowchart TD
...
- [`renderer`](graph/renderer.md) — 26 ADRs
