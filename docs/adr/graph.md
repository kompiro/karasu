...
191 ADRs across 15 topics. Clusters group by `topic` frontmatter field. Edges crossing cluster borders are cross-topic dependencies.
```mermaid
flowchart TD
...
- [`app-ui`](graph/app-ui.md) — 35 ADRs
