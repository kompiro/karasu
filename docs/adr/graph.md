...
> karasu@0.0.0 adr:visualize /workspaces/karasu/.worktrees/adr-visualize
> tsx scripts/adr/visualize.ts

# ADR Dependency Graph

Generated from `docs/adr/` (111 ADRs). Status colors: accepted (green), superseded / not_adopted (gray), deprecated (red), proposed (yellow). Arrows show `depends_on`; dashed arrows show `supersedes`.
```mermaid
flowchart TD
