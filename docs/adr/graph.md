...
263 ADRs across 15 topics. Clusters group by `topic` frontmatter field. Edges crossing cluster borders are cross-topic dependencies.
```mermaid
flowchart TD
  ...
  subgraph app-ui["app-ui"]
    ...
    ADR_20260515_01["ADR-20260515-01<br/>shadcn/ui と Tailwind v4 を packages/app に採用する"]
    ADR_20260519_01["ADR-20260519-01<br/>App サイドバーに AST Outline ビューを追加する"]
    ...
    ADR_20260520_06["ADR-20260520-06<br/>app.css をモジュール分割し、トークン層でライトテーマを提供する"]
    ADR_20260616_11["ADR-20260616-11<br/>gallery の example は id 指定・固定 origin fetch で app..."]
    ADR_20260715_02["ADR-20260715-02<br/>全 service をその場一括展開する — Collapse all / Expand al..."]
  end
  ...
  subgraph renderer["renderer"]
    ...
    ADR_20260716_02["ADR-20260716-02<br/>multi-system root view でも Group by: team を効かせる（..."]
  end
  ...
  class ADR_20260515_01 accepted
  class ADR_20260519_01 accepted
  ...
  class ADR_20260708_01 accepted
  class ADR_20260711_01 accepted
  class ADR_20260711_02 accepted
...
- [`renderer`](graph/renderer.md) — 37 ADRs
