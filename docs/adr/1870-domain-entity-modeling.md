...
- **関連**:
  ...
  - 関連 TPL: [TPL-1882](../test-perspectives/TPL-1882-entity-carries-no-attributes.md)、[TPL-1936](../test-perspectives/TPL-1936-cross-domain-entity-reference-qualified.md)、[TPL-1944](../test-perspectives/TPL-1944-inferred-tag-only-soft-fk.md)、[TPL-510](../test-perspectives/TPL-510-derivation-tag-semantics.md)、[TPL-2166](../test-perspectives/TPL-2166-information-flows-up.md)、[TPL-1223](../test-perspectives/TPL-1223-scoped-glance-drill-down.md)、[TPL-1720](../test-perspectives/TPL-1720-validation-target-set-enumerates-all-kinds.md)、[TPL-1827](../test-perspectives/TPL-1827-deep-link-anchor-cross-surface-parity.md)
...
（[TPL-2166](../test-perspectives/TPL-2166-information-flows-up.md)）。
...
1. **語彙 — 属性を持たない `entity`。** `entity` は `domain` の子で、保持するのは
   ...
   （[TPL-1882](../test-perspectives/TPL-1882-entity-carries-no-attributes.md)）。
...
4. **domain 配下のエンティティビュー。** domain drill-down に usecase と混載すると
   視覚密度原則（[TPL-1223](../test-perspectives/TPL-1223-scoped-glance-drill-down.md)）に
...
5. **permalink view token `entity`。** `#krs-entity-<id>[:<highlight>]` を追加。
   ...
   保つ（[TPL-1827](../test-perspectives/TPL-1827-deep-link-anchor-cross-surface-parity.md)）。
...
6. **診断 `entity-anchor-collision`（warning）。** `entity` token の
   ...
   加えてカバーする（[TPL-1720](../test-perspectives/TPL-1720-validation-target-set-enumerates-all-kinds.md)）。
...
7. **`translate --from db` が entity + 関連スキャフォールドを吐く。** aggregate
   ...
   - **Soft FK 由来（`REFERENCES` 宣言なし）の関連にのみシステム自動付与タグ
     ...
     （[TPL-1944](../test-perspectives/TPL-1944-inferred-tag-only-soft-fk.md)）。
