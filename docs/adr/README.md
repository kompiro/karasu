...
- [ADR-20260720-02](20260720-02-formatter-top-level-exhaustiveness.md) — formatter の top-level 網羅は手で列挙せず `KrsFile` から導出して型と test で強制する
...
- [ADR-20260420-03](20260420-03-i18n-rollout.md) — i18n Rollout — English / Japanese UI, Diagnostics, and Chat（#34 全体）
...
- [ADR-20260430-02](20260430-02-bundled-all-views-diff.md) — `karasu diff` の bundled all-views 出力（既定で 3 view を 1 SVG に束ねる）
