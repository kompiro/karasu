...
Auto-generated by `pnpm adr:regenerate`. 195 of 203 ADRs are currently `status: accepted` with no `superseded_by`.
...
- [ADR-20260615-02](20260615-02-migration-intent-fields.md) — ライフサイクルアノテーションに移行 intent パラメータを持たせる
