...
Auto-generated by `pnpm adr:regenerate`. 128 of 134 ADRs are currently `status: accepted` with no `superseded_by`.
...
- [ADR-20260429-06](20260429-06-client-capability-modeling.md) — client の capability 軸 — device / browser permission の語彙設計
