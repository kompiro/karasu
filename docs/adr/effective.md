...
Auto-generated by `pnpm adr:regenerate`. 298 of 307 ADRs are currently `status: accepted` with no `superseded_by`.
...
- [ADR-1628](1628-docs-site-examples-gallery.md) — docs-site の Examples gallery は examples/ をビルド時レンダリングして出す（SVG はコミットしない）
...
- [ADR-1890](1890-ci-runner-ubicloud.md) — CI ランナーは Ubicloud を採用し、secret を握る publish / deploy ジョブは GitHub ホストに残す
...
- [ADR-2124](2124-version-vocabulary.md) — version vocabulary — 言語版とパッケージ semver は独立の軸とし、言語版を first-class で公開する
