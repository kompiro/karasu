...
Auto-generated by `pnpm adr:regenerate`. 130 of 136 ADRs are currently `status: accepted` with no `superseded_by`.
...
- [ADR-20260428-05](20260428-05-vscode-webview-manual-tests.md) — VS Code WebView の DOM 系テストはマニュアル運用とする
