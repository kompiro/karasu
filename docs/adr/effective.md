...
Auto-generated by `pnpm adr:regenerate`. 121 of 127 ADRs are currently `status: accepted` with no `superseded_by`.
...
- [ADR-20260428-08](20260428-08-acceptance-test-automation-markers.md) — 受け入れテストの自動化マーカー規約と検出スクリプト
