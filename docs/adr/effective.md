...
Auto-generated by `pnpm adr:regenerate`. 108 of 114 ADRs are currently `status: accepted` with no `superseded_by`.
...
- [ADR-20260416-01](20260416-01-dompurify-adoption.md) — DOMPurify Adoption for HTML Sanitization
- [ADR-20260421-01](20260421-01-update-dependencies-20260420.md) — Dependency Updates — 2026-04-20
- [ADR-20260422-01](20260422-01-update-dependencies-20260421.md) — Dependency Updates — 2026-04-21
...
- [ADR-20260420-03](20260420-03-i18n-rollout.md) — i18n Rollout — English / Japanese UI, Diagnostics, and Chat
