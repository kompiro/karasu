...
Auto-generated by `pnpm adr:regenerate`. 129 of 136 ADRs are currently `status: accepted` with no `superseded_by`.
...
- [ADR-20260429-08](20260429-08-vscode-webview-e2e-automated.md) — VS Code WebView の DOM 系テストは ExTester ハーネスで自動化する
