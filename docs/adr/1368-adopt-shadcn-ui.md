...
# ADR-1368: shadcn/ui と Tailwind v4 を packages/app に採用する

- **日付**: 2026-05-15
- **ステータス**: 採用
- **関連**:
  - [ADR-9012 app-testing-strategy](9012-app-testing-strategy.md)
  - [ADR-40 testing-library-react](40-testing-library-react.md)
  - [ADR-9004 css-inspired-styling](9004-css-inspired-styling.md)
  - [ADR-176 vscode-phase3-webview-architecture](176-vscode-phase3-webview-architecture.md)
