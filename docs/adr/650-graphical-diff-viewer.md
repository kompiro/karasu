...
4. Phase 4: ペースト入力・OPFS スナップショット
   - ✅ #739 (PR #782): ペースト入力 — FileTree ヘッダに「⇄ Paste」ボタン、モーダルダイアログ、隠しファイル `.karasu-paste-compare.krs` 経由で `compileSystemDiff` に接続（詳細は ADR-739）
   - #740: OPFS スナップショット入力
