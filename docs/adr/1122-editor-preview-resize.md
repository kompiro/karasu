...
- **関連**:
  ...
  - ADR-1108（アクティビティバー + サイドバー構造の導入）— サイドバー側のリサイズと対をなす
...
編集領域とプレビュー領域を等分していた。サイドバー幅は ADR-1108 で
...
リサイズが提案されたが、調査の結果サイドバー側は ADR-1108 で
...
- ADR-1108（アクティビティバー + サイドバー構造） — サイドバー側の
  リサイズと永続化キー命名の前例
