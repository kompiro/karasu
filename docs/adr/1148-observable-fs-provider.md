...
# ADR-1148: FileTree の外部書き込み反映 — ObservableFileSystemProvider で fs ラッパー経由に集約する
...
- **関連**:
  ...
  - 親 ADR: [ADR-9006](./9006-project-and-filesystem.md)（`FileSystemProvider` 抽象）
  - 関連 ADR: [ADR-1076](./1076-gui-driven-style-editing.md)、[ADR-1144](./1144-krs-style-open-affordance.md)
