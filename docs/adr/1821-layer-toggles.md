...
date: 2026-06-30
topic: renderer
related_to: [ADR-1724, ADR-1728, ADR-1783]
scope:
  packages: [core, app]
assumptions:
...
# ADR-1821: layer toggles — external/infra カテゴリの対話的 collapse/expand
