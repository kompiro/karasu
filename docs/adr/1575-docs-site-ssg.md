...
# ADR-1575: docs/ を single source of truth として Astro Starlight でドキュメントサイトを生成する
...
- examples gallery + rendered diagram 埋め込み（#1574 / ADR-1574 の SVG 消費）、`@karasu-tools/app` の playground 埋め込み、versioned docs。
