...
assumptions:
  ...
  - "file: docs/test-perspectives/TPL-20260514-06-diagnostic-register-fact-vs-style.md"
---
...
- **関連**:
  ...
  - 派生 TPL: [TPL-20260514-06](../test-perspectives/TPL-20260514-06-diagnostic-register-fact-vs-style.md)（事実 vs 流派判断による register 選択）
...
判定樹（concept 節と TPL-20260514-06 で双方向リンク済み）:
...
- **proactive な TPL 化に乗る**: 本立場は `docs/concepts.md` に文書化され、TPL-20260514-06 が新規 diagnostic 追加 PR の checklist として機能する。これにより同種の判断（次の流派 prescription 提案）は原理から再導出できる。
...
- **TPL**: [TPL-20260514-06](../test-perspectives/TPL-20260514-06-diagnostic-register-fact-vs-style.md) が新規 diagnostic 追加 PR の checklist として運用される。
