...
date: 2026-04-29
topic: cli
related_to: [ADR-20260420-02, ADR-20260422-06, ADR-20260422-07, ADR-20260427-03]
assumptions:
...
- [#1025](https://github.com/kompiro/karasu/issues/1025) — bundled all-views diff（CLI 既定で 3 view を 1 SVG に束ねる）
