...
# ADR-788: ADR knowledge graph — machine-readable frontmatter + tooling
...
- **関連**:
  ...
  - [ADR-442](442-structural-krs-patch.md) — テキスト→構造化データへの段階移行の先行事例
  - [ADR-808](808-adr-body-ref-check.md) — body↔frontmatter 参照一貫性の follow-up
