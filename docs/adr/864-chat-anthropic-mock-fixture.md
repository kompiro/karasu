...
# ADR-864: Chat UI E2E は Playwright route で Anthropic API を mock する
...
- **関連**:
  ...
  - 関連 ADR: [ADR-903](903-skip-secret-gated-jobs-on-bot-prs.md)（bot PR で secret を流せない制約）
...
- **本物の API キーが必要** — bot PR では secret を流せない（ADR-766）
