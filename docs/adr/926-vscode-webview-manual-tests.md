...
# ADR-926: VS Code WebView の DOM 系テストはマニュアル運用とする

- **日付**: 2026-04-28
- **ステータス**: 廃止（2026-04-29 ADR-1014 で supersede）
- **関連**:
...
ADR-863 で導入した `packages/vscode-e2e` は `@vscode/test-cli` を
...
- AT-0037-9 / AT-0038 / AT-0039 / AT-0042-vscode の冒頭に
  「**Coverage policy: manual** — see ADR-926」を明記する。
