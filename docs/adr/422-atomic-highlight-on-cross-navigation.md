...
# ADR-422: クロスナビゲーション時のアトミックなハイライト適用

- **日付**: 2026-04-09
- **ステータス**: 決定済み
- **関連**: Issue #422, [ADR-9007](9007-interactive-svg-rendering.md), [ADR-177](177-node-click-ux.md)
...
- ブラウザバック/フォワード時のハイライト復元（Issue #425 → ADR-425）は本決定の後続で別途対応
