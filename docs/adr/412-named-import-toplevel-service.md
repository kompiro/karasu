...
# ADR-412: トップレベル service の Named Import — スタブ補完 + エッジ参照による自動メンバーシップ

- **日付**: 2026-04-09
- **ステータス**: 決定済み
- **関連**: Issue #412, [ADR-292](292-directory-import.md), [ADR-281](281-wildcard-import-two-pass-resolution.md)
