...
# ADR-1076: GUI 駆動の `.krs.style` 編集 — Preview コンテキストメニューから append round-trip
...
- **関連**:
  ...
  - 兄弟 ADR: [ADR-1096](./1096-edge-id-selector.md)（edge ID selector）、[ADR-9019](./9019-edge-direction-style.md)（direction property）
...
- **last-wins 慣習（ADR-1061）に整合**: cascade で常に後勝ちが
