...
- **日付**: 2026-04-11
- **ステータス**: 決定済み
- **関連**: Issue #425, [ADR-0031](20260409-03-atomic-highlight-on-cross-navigation.md), [ADR-0054](20260404-05-browser-history-navigation.md)
...
既存の hash 形式との後方互換がなく、ADR-0054 の設計を大きく崩す。
