...
# ADR-22: SVG エクスポートの 2 フェーズ実装（現在ビュー + Full View 単一ファイル）

- **日付**: 2026-03-28（2026-03-30 更新）
- **ステータス**: 決定済み
- **関連**: Issue #22, [ADR-21](21-two-layer-rendering.md), [ADR-9007](9007-interactive-svg-rendering.md)
...
- ツールバーに「Export SVG」ボタンを追加（アイコン + テキストラベル、ADR-9009 準拠）
