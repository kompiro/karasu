...
date: 2026-07-13
topic: adr-tooling
related_to: [ADR-1829, ADR-1827, ADR-1801]
assumptions:
...
# ADR-1830: ADR→karasu permalink の検証は adr-tools の krs kind で行い karasu は config で adopt する
...
ADR-1829 は `permalink:` frontmatter を定義しつつ、その検証を #1830 に申し送り、
