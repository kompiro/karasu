...
# ADR-363: Chat UI AI 設計レビュー — プロンプト駆動 + トリガー二系統

- **日付**: 2026-04-22
- **ステータス**: 決定済み
- **関連**:
  - Issue #363, Issue #362, PR #603 (Design Doc), PR #605 (実装)
  - ADR-362 (`362-chat-ui-panel.md`) — Chat UI Panel
  - ADR-420 (`420-chat-ui-phase3-structured-interview.md`) — Structured Interview
