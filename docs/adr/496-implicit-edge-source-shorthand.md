...
# ADR-496: ブロック内エッジの暗黙 source 簡略記法

- **日付**: 2026-04-12
- **ステータス**: 決定済み
- **関連**: Issue #496, Issue #477, [ADR-477](477-deprecated-domain-migration-coexistence.md), [ADR-438](438-krs-formatter.md)
...
この課題は ADR-477（#477: 移行期のドメイン共存）の受け入れテスト作成時に発見された。
