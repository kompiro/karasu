...
# ADR-1469: コマンドパレットのコマンド名は当面 i18n せず、解説追加時にまとめて対応する
...
- **関連**:
  ...
  - 関連 ADR: [ADR-1421](1421-app-command-palette.md)（コマンドパレット）, [ADR-1411](1411-app-keyboard-shortcuts.md)（キーボードショートカット基盤）
