...
- **関連 ADR**: [ADR-1508](../adr/1508-annotation-badge-label-i18n.md)
- **関連 TPL**: [TPL-1415](../test-perspectives/TPL-1415-shared-vocabulary-dual-representation.md), [TPL-1001](../test-perspectives/TPL-1001-display-mode-cross-surface.md), [TPL-219](../test-perspectives/TPL-219-parallel-function-parity.md)
...
- [x] 無注入時の builtin バッジラベルが `reference-data.ts` の en ラベルと dark / light 両テーマで一致する（TPL-1415）
