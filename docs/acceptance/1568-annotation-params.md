...
組み込みライフサイクルアノテーションに `@name(key: "value")` パラメータを持たせる言語層機能の受け入れ基準。設計は [ADR-1568](../adr/1568-migration-intent-fields.md)。値解釈・表示の消費者は [#1595](https://github.com/kompiro/karasu/issues/1595) で後続。
