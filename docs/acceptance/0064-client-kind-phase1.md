...
（Issue [#849](https://github.com/kompiro/karasu/issues/849)、設計は [#823](https://github.com/kompiro/karasu/issues/823) / `docs/adr/823-client-mcp-modeling.md`）。
...
- `examples/ja/getting-started/` を新規プロジェクトとしてアプリで開ける状態
...
- 設計ドキュメント: `docs/adr/823-client-mcp-modeling.md`
