...
- **Related TPLs**: [TPL-1761](../test-perspectives/TPL-1761-external-side-placement-invariant.md)（external サイド配置の不変条件）, [TPL-1736](../test-perspectives/TPL-1736-tier-split-no-edge-penetration.md)
