...
- **Related TPLs**: [TPL-2446](../test-perspectives/TPL-2446-gate-side-check-runs-over-the-whole-set.md)（gate 側の検証は全体を覆う）、[TPL-1720](../test-perspectives/TPL-1720-validation-target-set-enumerates-all-kinds.md)（列挙は最後に足したものを取りこぼす）、[TPL-2185](../test-perspectives/TPL-2185-drift-guard-distinguishes-declaration-from-mention.md)（宣言と言及を区別する）
- **対象ファイル**:
