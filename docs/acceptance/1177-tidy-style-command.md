...
- **対象ファイル**:
  ...
  - App: `packages/app/src/components/EditPaneToolbar.tsx`、`packages/app/src/components/EditPane.tsx`、`packages/app/src/components/EditArea.tsx`、`packages/app/src/components/AppShell.tsx`、`packages/app/src/components/EditPaneToolbar.test.tsx`、`packages/app/src/styles/components/navigation.css`
  - VS Code: `packages/vscode/src/extension.ts`、`packages/vscode/package.json`、`packages/lsp/src/server.ts`（formatter のルーティング）
- **関連 Design Doc**: [`docs/adr/1177-tidy-style-and-trivia.md`](../adr/1177-tidy-style-and-trivia.md)（Phase 2 計画 — 本 PR は step 3 of 3）
