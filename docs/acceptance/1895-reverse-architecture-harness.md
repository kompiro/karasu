...
- **関連 ADR**: [ADR-1895](../adr/1895-reverse-architecture-harness.md)（元 Design Doc `reverse-architecture-skill.md` / `repo-reverse-engineer-harness.md` を集約）
- **関連 TPL**: [TPL-1101](../test-perspectives/TPL-1101-round-trip-guarantee.md)（round-trip）, [TPL-999](../test-perspectives/TPL-999-implicit-data-filtering.md)（暗黙フィルタ）, [TPL-2167](../test-perspectives/TPL-2167-id-not-label-for-identity.md)（id 同一性）
