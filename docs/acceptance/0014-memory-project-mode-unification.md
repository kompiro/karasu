...
> ✅ Automated — `packages/e2e/tests/at-0014-memory-project-mode-unification.spec.ts` › `Removing the organization block keeps the Org tab clickable with an empty placeholder (AC-3.3)`
