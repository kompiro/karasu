...
- **関連 ADR**: [ADR-1062](../adr/1062-crud-matrix-view.md)（本機能の決定）, [ADR-1046](../adr/1046-resource-crud-operations.md)（`operations` 構文）, [ADR-1061](../adr/1061-resource-rw-edges.md)（read/write edge 差別化）
