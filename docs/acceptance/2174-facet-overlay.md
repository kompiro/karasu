...
- **関連 ADR**: [ADR-2174](../adr/2174-facet-overlay.md)（本スライスの実装設計）/ [ADR-2065](../adr/2065-tags-and-facets.md)（プログラム決定）。どちらも [#2177](https://github.com/kompiro/karasu/issues/2177) で昇格
