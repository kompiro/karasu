...
- **日付**: 2026-04-24
- **ステータス**: 決定済み（[ADR-811](../adr/811-diff-open-file-as-entry.md) として昇格、[#825](https://github.com/kompiro/karasu/pull/825) で実装）
- **関連**:
  - ADR: [811-diff-open-file-as-entry.md](../adr/811-diff-open-file-as-entry.md)（本 design doc の決定版）
  ...
  - 既存 ADR: [650-graphical-diff-viewer.md](../adr/650-graphical-diff-viewer.md), [739-diff-paste-input-ui.md](../adr/739-diff-paste-input-ui.md), [740-opfs-snapshot-diff-source.md](../adr/740-opfs-snapshot-diff-source.md)
