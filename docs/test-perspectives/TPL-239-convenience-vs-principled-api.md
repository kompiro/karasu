...
# TPL-239: consumer の境界では convenience API ではなく principled API を使う
...
- convenience を呼んでいる consumer が見つかったら、そのコードに **TPL-239 を引用したコメント** を付けて「ここは principled でない理由」を明示するか、principled に切り替える
