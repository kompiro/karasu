...
date: 2026-05-10
applicable_to:
  - "ユーザーの連続入力（IME composition / drag / touch / 長押し）を扱う UI コンポーネント"
  - "controlled component の値や DOM を、操作の境界を跨いで頻繁に書き換える処理"
known_consumers:
  - editor-pane
  - app-shell
discovered_from:
...
# TPL-1053: ユーザーの連続操作中は DOM / state を破壊する別系統の処理を抑止する
