...
# TPL-1385: 同名 database / queue / storage の再宣言は union merge、info 診断で surface する
...
- ADR-1381（spec の根拠）
- [ADR-1386](../adr/1386-style-prescription-stance.md)（info severity 採用の経緯。設計 doc `docs/design/karasu-position-on-style-prescriptions.md` は #1392 で ADR に昇格し削除済み）
