...
related_to: [TPL-1415, TPL-1927]
topic: renderer
scope:
  packages: [core]
---

# TPL-1736: system-view のティアを分割/挿入したら、新たに段を跨ぐエッジが中間カードを貫通しないことを確認する
...
- [ ] shape / icon 両 displayMode でティア構造が成立することを確認した（[TPL-1001](TPL-1001-display-mode-cross-surface.md)）
