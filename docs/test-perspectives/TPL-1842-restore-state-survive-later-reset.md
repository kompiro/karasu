...
# TPL-1842: URL/共有から復元する state は、後発の seed reset を越えて再適用する
...
なし（retrospective TPL — #1842 から抽出）。共有 encode/restore の anchor 文法側は [[TPL-1827-deep-link-anchor-cross-surface-parity]] が守る。
