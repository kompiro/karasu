...
# TPL-976: E2E テストは fixture が状態 / 環境 / 後始末をすべて所有し、リーク経路を post-merge で監視する
...
- 既存 fixture（`anthropic.ts` の locale pin）を**テンプレートとして他 fixture にコピー**する。新しい環境変数 / 状態軸を追加するときは、すべての fixture に同期して入れる（→ TPL-219 の parallel-implementation parity と同じ思想）
