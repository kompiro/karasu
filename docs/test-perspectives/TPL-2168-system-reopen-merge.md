...
# TPL-2168: 同名 system / deploy / organization の再オープンは children を union し、property は import-graph root に近い側が勝つ
...
- `deploy` / `organization` を merge 対象から外すと、physical / org ビューが部分的に欠ける（TPL-2169）
