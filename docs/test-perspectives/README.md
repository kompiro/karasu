...
| [TPL-2909](TPL-2909-pending-items-need-stable-ids-not-a-moving-window.md) | 処理待ちの項目は、動く窓（いま head か・最後の行動より後か）で絞り込まず項目自身の安定 id で持つ。窓が動いた瞬間に未処理のまま視界から消え、消えたことは残らないので「未処理 0」は満たされてしまう。thread のように carrier を持つ種類だけを見て 0 件と報告すると、持たない種類は必ず取りこぼす | project | #2909, #2887 |
