...
| [TPL-20260624-03](TPL-20260624-03-external-side-placement-invariant.md) | system-view で external をサイドに置く配置は、他 kind の配置帯を侵さず決定的で、column override を尊重する | renderer | ADR-20260623-06, #1728 |
