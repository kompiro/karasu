...
- [x] pnpm run build (AT-0001, AT-0006)
- [x] pnpm run test — 230 tests passed (AT-0001, AT-0006)
- [x] pnpm run lint (AT-0006)
- [x] pnpm run format:check (AT-0006)
...
- コマンドの実行に時間がかかる場合（特に `npx vitest run`）はユーザーに進捗を伝える
