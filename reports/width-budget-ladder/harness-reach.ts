...
const CONFIGS: ConfigSpec[] = [
  ...
  cfg("m2s3", "steps 3, reach 2x", "short reach, coarse", 3, 2, null),
  cfg("m2s4", "steps 4, reach 2x", "short reach", 4, 2, null),
  cfg("m2s5", "steps 5, reach 2x", "short reach", 5, 2, null),
  cfg("m2s6", "steps 6, reach 2x", "short reach, same ratio as today", 6, 2, null),
  cfg("m2s8", "steps 8, reach 2x", "short reach, fine", 8, 2, null),
  cfg("m3s5", "steps 5, reach 3x", "medium reach", 5, 3, null),
  cfg("m3s6", "steps 6, reach 3x", "medium reach", 6, 3, null),
  cfg("m3s8", "steps 8, reach 3x", "medium reach, fine", 8, 3, null),
];
...
function main(): void {
  ...
  writeFileSync(
    "reports/width-budget-ladder/data-reach.json",
